...
find $script_location/.. -name pom.xml -exec sed -i 's/4.36.0/4.37.0/g' {} \;
find $script_location/.. -name MANIFEST.MF -exec sed -i 's/4.36.0/4.37.0/g' {} \;
find $script_location/.. -type f -name *.product -exec sed -i 's/4.36.0/4.37.0/g' {} \;
find $script_location/.. -name feature.xml -exec sed -i 's/4.36.0/4.37.0/g' {} \;
